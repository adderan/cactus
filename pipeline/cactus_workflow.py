    ...
    def run(self):
        ...
        self.addChildTarget(BlastIngroupsAndOutgroups(
                                          BlastOptions(chunkSize=getOptionalAttrib(findRequiredNode(self.cactusWorkflowArguments.configNode, "caf"), "chunkSize", int),
                                                        ...
                                                        lastdbArguments=getOptionalAttrib(findRequiredNode(self.cactusWorkflowArguments.configNode, "caf"), "lastdbArguments"),
                                                        lastalArguments=getOptionalAttrib(findRequiredNode(self.cactusWorkflowArguments.configNode, "caf"), "lastalArguments"),
...
class CactusCafWrapper(CactusRecursionTarget):
    ...
    def runCactusCafInWorkflow(self, alignmentFile):
        ...
        messages = runCactusCaf(cactusDiskDatabaseString=self.cactusDiskDatabaseString,
                          ...
                          lastdbArguments=self.getOptionalPhaseAttrib("lastdbArguments"),
                          lastalArguments=self.getOptionalPhaseAttrib("lastalArguments"),
